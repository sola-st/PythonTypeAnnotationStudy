...
# repo_qualifier = ''
# headers = {'Authorization': 'token %s' % '6ae6e7a4dff522e6f2faf2319b14ea51f8a00cb3'}
# req_count = 0
...
#     data = json.load(f)  
#     for r in data:
#       query = 'fixing+typing+repo:'+r['full_name']

#       # Call search API until no more "fixing typing" commits in this repo
#       for i in range(1,11): # page 1-10, GitHub Search API provides up to 1,000 results for each search.
#         try:
#           filename = 'Resources/Input/TypeFix/top10000/' + query.replace('/','-') + '_commits_page'+str(i)+'.json'
