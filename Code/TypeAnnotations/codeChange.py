...
class SingleDiffChange:
    ...
    def __init__(self, type, old_or_new, filename, variable, annotation, line, col=None):
        self.type = type
    ...
    def __members(self):
        return self.type, self.old_or_new, self.variable, self.annotation, self.line, self.col
